...
macro_rules! __export_world_fetch_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        ...
        __post_return_fetch::<$ty > (arg0) } #[export_name = "web-search"] unsafe extern
        "C" fn export_web_search(arg0 : * mut u8, arg1 : usize, arg2 : i32, arg3 : i32,
        arg4 : * mut u8, arg5 : usize, arg6 : i32, arg7 : * mut u8, arg8 : usize,) -> *
        mut u8 { $($path_to_types)*:: _export_web_search_cabi::<$ty > (arg0, arg1, arg2,
        arg3, arg4, arg5, arg6, arg7, arg8) } #[export_name = "cabi_post_web-search"]
        unsafe extern "C" fn _post_return_web_search(arg0 : * mut u8,) {
        $($path_to_types)*:: __post_return_web_search::<$ty > (arg0) } };
    };
}
#[doc(hidden)]
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07z\x01A\x02\x01A\x06\x01\
j\x01s\x01s\x01@\x01\x03urls\0\0\x04\0\x05fetch\x01\x01\x01ks\x01@\x04\x05querys\
\x0bmax-resultsy\x08language\x02\x06region\x02\0\0\x04\0\x0aweb-search\x01\x03\x04\
\x01\x18component:fetch-rs/fetch\x04\0\x0b\x0b\x01\0\x05fetch\x03\0\0\0G\x09prod\
