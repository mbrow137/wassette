...
build-examples mode="debug":
    ...
    (cd examples/html-to-markdown-rs && just build mode)
    ...
    cp examples/html-to-markdown-rs/target/wasm32-wasip2/{{ mode }}/html_to_markdown_rs.wasm bin/html-to-markdown-rs.wasm
