...
- HTML to Markdown Rust WebAssembly component example with comprehensive HTML element support including headers, paragraphs, links, lists, blockquotes, code blocks, and text formatting, along with unit tests and integration tests ([#TBD](https://github.com/microsoft/wassette/pull/TBD))
