...
- **SECURITY**: OCI signature verification framework with configurable trust roots and secure defaults - foundation for cosign/sigstore integration ([#25](https://github.com/microsoft/wassette/pull/25))
